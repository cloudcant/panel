...
def si():
    print('\x1b[38;2;0;255;255m[ \x1b[38;2;233;233;233m1337 \x1b[38;2;0;255;255m] | \x1b[38;2;233;233;233mWelcome to Storm Cloud Net! \x1b[38;2;0;255;255m')
    print("")
...
def menu():
    sys.stdout.write(f"\x1b]2;Storm Cloud Net --> Bots : [{bots}] | Online Users: [1] | Methods: [25] | Bypass: [10] | Amps: [1]\x07")
    clear()
    print('\x1b[38;2;0;255;255m[ \x1b[38;2;233;233;233mroot \x1b[38;2;0;255;255m] | \x1b[38;2;233;233;233mWelcome to Storm Cloud Net! \x1b[38;2;0;255;255m')
    print("")
    print("""                                                                                                                                                 
                    ▓▓▓▓▓▓                
                  ██░░░░░░██              
...
def main():
    menu()
    while(True):
        cnc = input('''\x1b[38;2;0;212;14m╔══[root\x1b[38;2;0;186;45m@StormCloud\x1b[38;2;0;186;45m]
...
def login():
    ...
    if username != user or password != passwd:
        ...
        print("</> Welcome to Storm Cloud Net!")
        time.sleep(0.3)
        ascii_vro()
        main()
